...
messageRouter.post("/:chatId", __protect, (0, asyncErrorHandler_1.default)(messageController.addMessage));
messageRouter.put("/read/:chatId/:id", __protect, (0, asyncErrorHandler_1.default)(messageController.readMessage));
